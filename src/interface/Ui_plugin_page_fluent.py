...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        icon = QIcon()
        icon.addFile(u":/Icons/materialIcons/icons8_info.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
    ...
    def retranslateUi(self, Form):
        ...
        self.PushButton.setText(QCoreApplication.translate("Form", u"\u67e5\u770b\u5df2\u9009\u62e9", None))
#if QT_CONFIG(tooltip)
        self.PrimaryPushButton.setToolTip(QCoreApplication.translate("Form", u"\u8be5\u9009\u9879\u4f1a\u81ea\u52a8\u5206\u6790\u9879\u76ee\u76ee\u5f55\u4e0b\u53ef\u4ee5\u5f00\u542f\u7684\u63d2\u4ef6", None))
#endif // QT_CONFIG(tooltip)
        self.PrimaryPushButton.setText(QCoreApplication.translate("Form", u"\u81ea\u52a8\u5206\u6790", None))
    # retranslateUi
