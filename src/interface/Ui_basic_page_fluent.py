...
from qfluentwidgets import (BodyLabel, CaptionLabel, CardWidget, ElevatedCardWidget,
...
class Ui_basic_page(object):
    def setupUi(self, basic_page):
        ...
        icon = QIcon()
        icon.addFile(u":/Icons/materialIcons/no_file.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.LBPyFilePath.setProperty(u"lightColor", QColor(96, 96, 96))
        ...
        self.SubtitleLabel_2.setProperty(u"pixelFontSize", 28)
        ...
        self.LBOutputPath.setProperty(u"strikeOut", False)
        ...
        self.SubtitleLabel_3.setProperty(u"pixelFontSize", 28)
        ...
        self.LBIcon.setProperty(u"strikeOut", False)
        ...
        icon2 = QIcon()
        icon2.addFile(u":/Icons/materialIcons/icons8_load_cargo.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
