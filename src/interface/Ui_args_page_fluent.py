...
from qfluentwidgets import (BodyLabel, CardWidget, ElevatedCardWidget, HyperlinkButton,
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        icon = QIcon()
        icon.addFile(u":/Icons/materialIcons/icons8_code.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon1 = QIcon()
        icon1.addFile(u":/Icons/materialIcons/icons8_broom.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
    ...
    def retranslateUi(self, Form):
        ...
        self.TextEdit.setPlaceholderText(QCoreApplication.translate("Form", u"Nuitka \u7684\u547d\u4ee4\u5728\u8fd9\u91cc\u8f93\u51fa", None))
#if QT_CONFIG(tooltip)
        self.HyperlinkButton_2.setToolTip(QCoreApplication.translate("Form", u"<html><head/><body><p>\u4ece NuitkaGUI \u83b7\u53d6\u547d\u4ee4</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.HyperlinkButton_2.setText(QCoreApplication.translate("Form", u"\u83b7\u53d6\u547d\u4ee4", None))
#if QT_CONFIG(tooltip)
        self.TextEdit_2.setToolTip(QCoreApplication.translate("Form", u"\u5f53\u524d\u4e0d\u652f\u6301\u81ea\u52a8\u5f00\u542f\u63d2\u4ef6\uff0c\u5728\u672a\u6765\u7684\u7248\u672c\u4f1a\u8fdb\u884c\u66f4\u65b0", None))
#endif // QT_CONFIG(tooltip)
        self.TextEdit_2.setPlaceholderText(QCoreApplication.translate("Form", u"\u590d\u5236 Nuitka \u7684\u547d\u4ee4\u5230\u8fd9\u91cc\u8fdb\u884c\u89e3\u6790", None))
#if QT_CONFIG(tooltip)
        self.HyperlinkButton.setToolTip(QCoreApplication.translate("Form", u"<html><head/><body><p>\u6839\u636e\u547d\u4ee4\u9006\u5411\u56de NuitkaGUI</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.HyperlinkButton.setText(QCoreApplication.translate("Form", u"\u89e3\u6790\u547d\u4ee4", None))
#if QT_CONFIG(tooltip)
        self.PrimaryPushButton.setToolTip("")
#endif // QT_CONFIG(tooltip)
        self.PrimaryPushButton.setText(QCoreApplication.translate("Form", u"\u6e05\u7a7a\u6240\u6709\u53c2\u6570", None))
    # retranslateUi
